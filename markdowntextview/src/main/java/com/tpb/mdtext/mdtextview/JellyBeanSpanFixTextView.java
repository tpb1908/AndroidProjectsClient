...
public class JellyBeanSpanFixTextView extends AppCompatTextView {
    ...
    private void fixOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(text instanceof Spanned) {
            ...
            if(MarkdownTextView.DEBUG) {
                Log.d(MarkdownTextView.TAG, "The text isn't a Spanned");
            }
    ...
    private void fixSpannedWithSpaces(SpannableStringBuilder builder, int widthMeasureSpec,
        ...
        if(MarkdownTextView.DEBUG) {
            ...
            Log.d(MarkdownTextView.TAG, "fixSpannedWithSpaces() duration in ms: " + fixDuration);
        }
    }
    ...
    private FixingResult addSpacesAroundSpansUntilFixed(SpannableStringBuilder builder,
        ...
        if(MarkdownTextView.DEBUG) {
            Log.d(MarkdownTextView.TAG, "Could not fix the Spanned by adding spaces around spans");
        }
    ...
    private void fallbackToString(int widthMeasureSpec, int heightMeasureSpec) {
        if(MarkdownTextView.DEBUG) {
            Log.d(MarkdownTextView.TAG, "Fallback to unspanned text");
        }
