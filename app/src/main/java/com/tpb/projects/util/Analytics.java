...
public class Analytics {
    ...
    public static final String TAG_REPO_ACTIVITY = "REPO_ACTIVITY";
    public static final String KEY_PROJECT_COUNT = "PROJECT_COUNT";

    public static final String TAG_PROJECT_CREATION = "PROJECT_CREATION";
    ...
    public static final String TAG_CARD_TO_ISSUE = "CARD_TO_ISSUE";
    ...
    public static final String TAG_ISSUE_OPENED = "ISSUE_OPENED";

    public static final String TAG_ISSUE_CLOSED = "ISSUE_CLOSED";

    public static final String TAG_ISSUE_EDIT = "ISSUE_EDITED";
