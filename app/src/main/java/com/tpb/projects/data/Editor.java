...
public class Editor extends APIHandler {
    ...
    public void createProject(final @Nullable CreationListener<Project> listener, String name, String body, String repoFullName) {
        ...
        Log.i(TAG,
                "createProject: " + GIT_BASE + SEGMENT_REPOS + "/" + repoFullName + SEGMENT_PROJECTS
        );
    ...
    public void updateProject(final @Nullable UpdateListener<Project> listener, String name, String body, int id) {
    ...
    public void deleteProject(@NonNull DeletionListener<Project> listener, Project project) {
        /*
    ...
    public void openProject(@NonNull UpdateListener<Project> listener, int projectId) {
        final JSONObject obj = new JSONObject();
        try {
    ...
    public void closeProject(@NonNull UpdateListener<Project> listener, int projectId) {
        final JSONObject obj = new JSONObject();
        try {
    ...
    public void updateColumnName(@Nullable UpdateListener<Column> listener, int columnId, String newName) {
        final JSONObject obj = new JSONObject();
    ...
    public void addColumn(@Nullable CreationListener<Column> listener, int projectId, String name) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(NAME, name);
        } catch(JSONException jse) {
    ...
    public void moveColumn(@Nullable UpdateListener<Integer> listener, int columnId, int dropPositionId, int position) {
        final JSONObject obj = new JSONObject();
        try {
            if(position == 0) {
    ...
    public void deleteColumn(@Nullable DeletionListener<Integer> listener, int columnId) {
    ...
    public void createCard(@Nullable CreationListener<Pair<Integer, Card>> listener, int columnId, String note) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(NOTE, note);
        } catch(JSONException jse) {
    ...
    public void createCard(@Nullable CreationListener<Pair<Integer, Card>> listener, int columnId, int issueId) {
        final JSONObject obj = new JSONObject();
        try {
    ...
    public void updateCard(@Nullable UpdateListener<Card> listener, int cardId, String note) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(NOTE, note);
        } catch(JSONException jse) {
    ...
    public void moveCard(@Nullable UpdateListener<Integer> listener, int columnId, int cardId, int afterId) {
        final JSONObject obj = new JSONObject();
        try {
            if(afterId == -1) {
    ...
    public void deleteCard(@Nullable DeletionListener<Card> listener, Card card) {
        AndroidNetworking
    ...
    public void createIssue(@Nullable CreationListener<Issue> listener, String repoFullName, String title, String body, @Nullable String[] assignees, @Nullable String[] labels) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(TITLE, title);
            obj.put(BODY, body);
    ...
    public void closeIssue(@Nullable UpdateListener<Issue> listener, String fullRepoPath, int issueNumber) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(STATE, STATE_CLOSED);
        } catch(JSONException jse) {
        ...
        AndroidNetworking
                .patch(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoPath + SEGMENT_ISSUES + "/" + issueNumber)
                .addHeaders(API_AUTH_HEADERS)
                .addJSONObjectBody(obj)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
    ...
    public void openIssue(@Nullable UpdateListener<Issue> listener, String fullRepoPath, int issueNumber) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(STATE, STATE_OPEN);
        } catch(JSONException jse) {
    ...
    public void updateIssue(@Nullable UpdateListener<Issue> listener, String fullRepoPath, Issue issue, @Nullable String[] assignees, @Nullable String[] labels) {
        final JSONObject obj = new JSONObject();
        try {
        ...
        AndroidNetworking
                .patch(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoPath + SEGMENT_ISSUES + "/" + issue
                        .getNumber())
                .addHeaders(API_AUTH_HEADERS)
                .addJSONObjectBody(obj)
                .build()
    ...
    public void createComment(@Nullable CreationListener<Comment> listener, String fullRepoPath, int issueNumber, String body) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(BODY, body);
        } catch(JSONException jse) {
        ...
        AndroidNetworking
                .post(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoPath + SEGMENT_ISSUES + "/" + issueNumber + SEGMENT_COMMENTS)
                .addHeaders(API_AUTH_HEADERS)
                .addJSONObjectBody(obj)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
    ...
    public void updateComment(@Nullable UpdateListener<Comment> listener, String fullRepoPath, int commentId, String body) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(BODY, body);
        } catch(JSONException jse) {
        ...
        AndroidNetworking
                .patch(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoPath + SEGMENT_ISSUES + SEGMENT_COMMENTS + "/" + commentId)
                .addHeaders(API_AUTH_HEADERS)
                .addJSONObjectBody(obj)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
    ...
    public void deleteComment(@Nullable DeletionListener<Integer> listener, String fullRepoPath, int commentId) {
        AndroidNetworking
                .delete(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoPath + SEGMENT_ISSUES + SEGMENT_COMMENTS + "/" + commentId)
                .addHeaders(API_AUTH_HEADERS)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
    ...
    public void unstarRepo(@Nullable UpdateListener<Boolean> listener, String fullRepoName) {
    ...
    public void watchRepo(@Nullable UpdateListener<Boolean> listener, String fullRepoName) {
        AndroidNetworking.put(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoName + SEGMENT_SUBSCRIPTION)
                         ...
                         .getAsJSONObject(new JSONObjectRequestListener() {
                             ...
                             public void onResponse(JSONObject response) {
                                 Log.i(TAG,
                                         "onResponse: Subscription change " + response.toString()
                                 );
                                 try {
    ...
    public void unwatchRepo(@Nullable UpdateListener<Boolean> listener, String fullRepoName) {
        AndroidNetworking.put(GIT_BASE + SEGMENT_REPOS + "/" + fullRepoName + SEGMENT_SUBSCRIPTION)
                         .addHeaders(API_AUTH_HEADERS)
    ...
    public void createMilestone(@Nullable CreationListener<Milestone> listener, String fullRepoName, @NonNull String title, @Nullable String description, @Nullable String dueOn) {
        final JSONObject obj = new JSONObject();
        try {
            obj.put(TITLE, title);
    ...
    public void updateMilestone(@Nullable UpdateListener<Milestone> listener, String fullRepoName, int number, @Nullable String title, @Nullable String description, @Nullable String dueOn, @Nullable State state) {
        final JSONObject obj = new JSONObject();
        try {
