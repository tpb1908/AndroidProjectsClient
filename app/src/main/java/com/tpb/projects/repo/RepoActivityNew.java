...
import com.tpb.projects.repo.fragment.RepoFragment;
import com.tpb.projects.repo.fragment.RepoInfoFragment;
...
public class RepoActivityNew extends BaseActivity implements Loader.GITModelLoader<Repository> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repo_new);
