...
public class IssueEventsFragment extends IssueFragment {
    ...
    public static IssueEventsFragment getInstance(SwipeRefreshLayout refresher, MultiOnRefreshListener refreshListener) {
        final IssueEventsFragment frag = new IssueEventsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new IssueEventsAdapter(this, mRefresher, mRefreshListener);
